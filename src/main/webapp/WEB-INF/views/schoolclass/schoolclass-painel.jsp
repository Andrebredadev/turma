...
<body>
	...
	<div class="container">
		...
		<div class="d-flex justify-content-between">
			<h1>Painel de Turma</h1>
			<h3>
				<a class="btn btn-primary" href='<c:url value="/cadastroturma" />'> Cadastrar nova Turma </a>
			</h3>
				...
				<c:forEach var="schoolClass" items="${schoolClass}">
					<tr>
						...
						<a href='<c:url value="/formedit/schoolClass/${schoolClass.classID}" />'>
 						...
 						</a> <a href='<c:url value="/delete/schoolClass/${schoolClass.classID}" />'> 
